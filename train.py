...
##TRAIN_LOG_DIR = os.path.join('Log/train/', time.strftime('%Y-%m-%d %H:%M:%S', time.localtime(time.time())))  invalid argument
TRAIN_LOG_DIR = 'Log/train/'  ##2019-5-24 10:17 修改
TRAIN_CHECK_POINT = 'check_point/'5
